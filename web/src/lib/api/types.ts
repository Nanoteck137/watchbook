...
export const CreateReleaseBody = z.object({
  mediaId: z.string(),
  startDate: z.string(),
  numExpectedParts: z.number(),
  intervalDays: z.number(),
...
export type CreateReleaseBody = z.infer<typeof CreateReleaseBody>;
...
export const EditReleaseBody = z.object({
  startDate: z.string().nullable().optional(),
  numExpectedParts: z.number().nullable().optional(),
  intervalDays: z.number().nullable().optional(),
  delayDays: z.number().nullable().optional(),
});

export type EditReleaseBody = z.infer<typeof EditReleaseBody>;
