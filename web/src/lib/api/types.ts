...
export const CreateAnimeBody = z.object({
  type: z.string(),
  tmdbId: z.string(),
  malId: z.string(),
  anilistId: z.string(),
...
export type CreateAnimeBody = z.infer<typeof CreateAnimeBody>;
...
export const CreateAnime = z.object({
  id: z.string(),
});

export type CreateAnime = z.infer<typeof CreateAnime>;
