...
<a
  {href}
  class="group relative block aspect-[75/106] min-w-[160px] transform cursor-pointer overflow-hidden rounded bg-gray-900 shadow-md transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg"
>
  <!-- Badge -->
  {#if userList}
  ...
  <div
    class="flex min-w-[160px] items-center justify-center overflow-hidden bg-gray-800 text-gray-400"
  >
    {#if coverUrl}
